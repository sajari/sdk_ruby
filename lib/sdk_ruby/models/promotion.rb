...
module SajariAPIClient
  ...
  class Promotion
    ...
    def hash
      [banners, collection_id, condition, create_time, disabled, display_name, end_time, exclusions, filter_boosts, filter_conditions, id, pins, range_boosts, start_time, update_time].hash
    end
