...
module SajariAPIClient
  class QueryResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'feature_score')
        self.feature_score = attributes[:'feature_score']
      end
      ...
      if attributes.key?(:'neural_score')
        self.neural_score = attributes[:'neural_score']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          banner == o.banner &&
          feature_score == o.feature_score &&
          index_score == o.index_score &&
          neural_score == o.neural_score &&
          record == o.record &&
    ...
    def hash
      [banner, feature_score, index_score, neural_score, record, relevance_score, score, token].hash
    end
