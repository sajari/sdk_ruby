...
module SajariAPIClient
  class Collection
    ...
    def self.openapi_types
      {
        :'account_id' => :'String',
        :'authorized_query_domains' => :'Array<String>',
        :'create_time' => :'Time',
        :'display_name' => :'String',
        :'id' => :'String'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SajariAPIClient::Collection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SajariAPIClient::Collection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'authorized_query_domains')
        if (value = attributes[:'authorized_query_domains']).is_a?(Array)
          self.authorized_query_domains = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          authorized_query_domains == o.authorized_query_domains &&
    ...
    def hash
      [account_id, authorized_query_domains, create_time, display_name, id].hash
    end
