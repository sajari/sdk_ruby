...
module SajariAPIClient
  class EventsApi
    ...
    # @return [Object]
    def send_event(account_id, send_event_request, opts = {})
      data, _status_code, _headers = send_event_with_http_info(account_id, send_event_request, opts)
      data
    end
    ...
    def send_event_with_http_info(account_id, send_event_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventsApi.send_event ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling EventsApi.send_event"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def send_event2(send_event_request, opts = {})
      data, _status_code, _headers = send_event2_with_http_info(send_event_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def send_event2_with_http_info(send_event_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventsApi.send_event2 ...'
      end
      # verify the required parameter 'send_event_request' is set
      if @api_client.config.client_side_validation && send_event_request.nil?
        fail ArgumentError, "Missing the required parameter 'send_event_request' when calling EventsApi.send_event2"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EventsApi.send_event2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventsApi#send_event2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
