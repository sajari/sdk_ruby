...
pipeline = SajariAPIClient::Pipeline.new # Pipeline | The pipeline to create.

begin
  #Create pipeline
  result = api_instance.create_pipeline(collection_id, pipeline)
  p result
rescue SajariAPIClient::ApiError => e
  puts "Exception when calling PipelinesApi->create_pipeline: #{e}"
end
```
...
generate_pipelines_request = SajariAPIClient::GeneratePipelinesRequest.new # GeneratePipelinesRequest | 
...
begin
  ...
  puts "Exception when calling PipelinesApi->generate_pipelines: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling PipelinesApi->get_default_pipeline: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling PipelinesApi->get_default_version: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling PipelinesApi->list_pipelines: #{e}"
end
```
...
set_default_pipeline_request = SajariAPIClient::SetDefaultPipelineRequest.new # SetDefaultPipelineRequest | 
...
begin
  ...
  puts "Exception when calling PipelinesApi->set_default_pipeline: #{e}"
end
```
...
set_default_version_request = SajariAPIClient::SetDefaultVersionRequest.new # SetDefaultVersionRequest | 
...
begin
  ...
  puts "Exception when calling PipelinesApi->set_default_version: #{e}"
end
```
